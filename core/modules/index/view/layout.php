    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href=""> <sup><small><span class="label label-info">MEDIOS AUDIOVISUALES</span></large></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=oldreservations"><i class="fa fa-calendar"></i> Eventos Pasados</a></li>
          <li><a href="index.php?view=projects"><i class="fa fa-flask"></i> Ministerios</a></li>
          <li><a href="index.php?view=categories"><i class="fa fa-th-list"></i> Categoria</a></li>
